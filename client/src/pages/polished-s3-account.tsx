            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between mt-6">
                <button
                  ...
                  className="px-4 py-2 border border-input rounded-md shadow-sm text-sm font-medium bg-background hover:bg-muted/50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
                >
                  Back
                </button>
